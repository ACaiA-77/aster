...
<p align="center">
  <img src="assets/screenshots/aster-tui-intro.png" alt="aster TUI 启动界面" width="960">
</p>
...
| --- | --- |
| ![aster TUI 工具表](assets/screenshots/aster-tui-tools.png) | ![aster TUI skills 和 help](assets/screenshots/aster-tui-skills-help.png) |

| Memory 和 durable topics | Slash command 工作区 |
| --- | --- |
| ![aster TUI memory 和 skills](assets/screenshots/aster-tui-memory-skills.png) | ![aster TUI slash command 补全](assets/screenshots/aster-tui-latest.png) |
