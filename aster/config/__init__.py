...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "aster" / "config.toml"
PROJECT_CONFIG_NAME = ".aster.toml"
...
ENV_PROVIDER = "ASTER_PROVIDER"
ENV_API_KEY = "ASTER_API_KEY"
ENV_BASE_URL = "ASTER_BASE_URL"
ENV_MODEL = "ASTER_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("ASTER_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("ASTER_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("ASTER_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
            "ASTER_ANTHROPIC_API_KEY",
            "ANTHROPIC_API_KEY",
            "ASTER_RIGHT_CODES_API_KEY",
            "RIGHT_CODES_API_KEY",
            "ASTER_OPENAI_API_KEY",
            "OPENAI_API_KEY",
        ),
        "base_url": (
            "ASTER_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("ASTER_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("ASTER_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "ASTER_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("ASTER_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("ASTER_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("ASTER_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid Aster config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read Aster config file {path}: {exc}") from exc
