...
SKILL_FILE_CREATION_GUIDE = """When creating Aster skill files at .aster/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${ASTER_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".aster" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".aster" / "skills", "project"),
    ]
