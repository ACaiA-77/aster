...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available Aster skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a Aster skill."),
    ...
    SlashCommand("exit", "/exit", "Exit Aster.", ("quit",)),
)
